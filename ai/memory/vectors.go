...
type filters struct {
	...
	Importance       *int          `json:"importance,omitempty" description:"Importance score from 1 to 5 indicating how critical this memory is for personalization and future recall.\n1 = low value, rarely needed.\n3 = normal.\n5 = very important, central to subject identity, long-term goals, or behavior.\nExamples: 'Never reply in Telugu' → 5; 'I like this one song' → 2 or 3."`
